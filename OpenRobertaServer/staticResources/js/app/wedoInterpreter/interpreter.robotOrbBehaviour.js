...
define(["require", "exports", "interpreter.aRobotBehaviour", "interpreter.constants", "interpreter.util"], function (require, exports, interpreter_aRobotBehaviour_1, C, U) {
    ...
    var RobotOrbBehaviour = /** @class */ (function (_super) {
        ...
        RobotOrbBehaviour.prototype.driveAction = function (_name, _direction, _speed, _distance) {
            throw new Error("Method not implemented.");
        };
        RobotOrbBehaviour.prototype.curveAction = function (_name, _direction, _speedL, _speedR, _distance) {
            throw new Error("Method not implemented.");
        };
        RobotOrbBehaviour.prototype.turnAction = function (_name, _direction, _speed, _angle) {
            throw new Error("Method not implemented.");
        };
